import FormData, { FormData as FormDataType, Agreements, PurchaseOrder, VisaDetails, IQAMARenewals, InsuranceRenewals } from '../models/OfficeModel'; // Adjust the import based on your structure
...
class FormDataRepository {
  ...
  async update(id: string, updateData: Partial<Omit<FormDataType, 'id'>>): Promise<FormDataType | null> {
